...
import { DofPointsMaterial } from "@/components/shaders/pointMaterial";
import { SimulationMaterial } from "@/components/shaders/simulationMaterial";
...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    easing.damp(dofPointsMaterial.uniforms.uTransition, "value", 0, 0.2, delta);
    ...
    simulationMaterial.uniforms.uTimeScale.value = (timeScale ?? 0.3) * speed;
